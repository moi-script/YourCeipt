...
// Kept in lib/categories so AuthContext can use them without pulling in
// this page (and Recharts) on every route.
export { CATEGORY_MAP, CATEGORY_CONFIG } from "@/lib/categories";
